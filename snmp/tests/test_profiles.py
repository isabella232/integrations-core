...
def test_cisco_asa(aggregator):
    profile = "cisco-asa"
    run_profile_check('cisco_asa', profile)
    ...
    aggregator.assert_metric('snmp.cufwConnGlobalConnSetupRate1', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnGlobalConnSetupRate5', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    ...
    aggregator.assert_metric('snmp.cufwConnGlobalNumPolicyDeclined', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnGlobalNumRemoteAccess', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnGlobalNumResDeclined', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnGlobalNumSetupsAborted', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfAllowModeReqNumAllowed', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfAllowModeReqNumDenied', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    ...
    aggregator.assert_metric('snmp.cufwUrlfRequestsNumCacheAllowed', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfRequestsNumCacheDenied', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfRequestsNumDenied', metric_type=aggregator.GAUGE, tags=common_tags, count=1)
    aggregator.assert_metric('snmp.cufwUrlfRequestsNumProcessed', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfRequestsNumResDropped', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    ...
    aggregator.assert_metric('snmp.cufwUrlfResTotalRequestCacheSize', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfResTotalRespCacheSize', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwUrlfResponsesNumLate', metric_type=aggregator.GAUGE, tags=common_tags, count=1)
    aggregator.assert_metric('snmp.cufwUrlfUrlAccRespsNumResDropped', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnResActiveConnMemoryUsage', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnResEmbrConnMemoryUsage', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    aggregator.assert_metric('snmp.cufwConnResHOConnMemoryUsage', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=1)
    ...
    aggregator.assert_metric('snmp.cufwAppConnNumPolicyDeclined', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)
    aggregator.assert_metric('snmp.cufwAppConnNumResDeclined', metric_type=aggregator.GAUGE, tags=common_tags, count=3)
    aggregator.assert_metric('snmp.cufwAppConnNumSetupsAborted', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)
    ...
    aggregator.assert_metric('snmp.cufwPolAppConnNumPolicyDeclined', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)
    aggregator.assert_metric('snmp.cufwPolAppConnNumResDeclined', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)
    aggregator.assert_metric('snmp.cufwPolAppConnNumSetupsAborted', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)
    ...
    aggregator.assert_metric('snmp.cufwPolConnNumPolicyDeclined', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)
    aggregator.assert_metric('snmp.cufwPolConnNumResDeclined', metric_type=aggregator.GAUGE, tags=common_tags, count=3)
    aggregator.assert_metric('snmp.cufwPolConnNumSetupsAborted', metric_type=aggregator.GAUGE, tags=common_tags,
                             count=3)

    sensor_types = [3,5,6]
    for index in range(3):
        aggregator.assert_metric('snmp.entPhySensorValue', metric_type=aggregator.GAUGE, tags=common_tags + ['sensor_id:{}'.format(index), 'sensor_type:{}'.format(sensor_types[index])], count=1)
        aggregator.assert_metric('snmp.entPhySensorOperStatus', metric_type=aggregator.GAUGE, tags=common_tags + ['sensor_id:{}'.format(index), 'sensor_type:{}'.format(sensor_types[index])], count=1)
